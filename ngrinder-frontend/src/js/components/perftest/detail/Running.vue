            ...
            <div class="form-horizontal form-horizontal-3" style="margin-top:10px;">
                <fieldset>
                    ...
                    <div class="control-group">
                        <control-group v-if="test.threshold === 'D'" labelMessageKey="perfTest.running.duration">
                            <span v-text="test.durationStr"></span>
                            <code>HH:MM:SS</code>
...
<script>
    ...
    export default class Running extends Base {
        ...
        updateSamplingData() {
            ...
            console.log('updateSamplingData() is called');
